...
public class RangeRuleDateCornerCasesTest {
    ...
    public void should_set_low_and_high_end_values_for_multirange() {
        ...
        Assert.assertTrue("One user must be born a millisecond before 7 days ago",
                user7DaysAgoMinusMillisecond);

        Assert.assertTrue("One user must be born exactly 5 days ago", userExactly5DaysAgo);
        Assert.assertTrue("One user must be born a millisecond before 3 days ago",
                user3DaysAgoMinusMillisecond);
    }
