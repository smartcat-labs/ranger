...
public interface DataSource<T> {
     ...
     * Time can be used for implementing time dependent data source which
     * can then return data with time stamps and/or data influenced by time in any other way.
