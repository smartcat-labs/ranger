 ...
 */
public class AdditionValueLong extends Value<Long> {
     ...
     */
    @SuppressWarnings("rawtypes")
    public AdditionValueLong(Value summand1, Value summand2) {
    ...
    @Override
    protected void eval() {
        val = ((Number) summand1.get()).longValue() + ((Number) summand2.get()).longValue();
    }
}
