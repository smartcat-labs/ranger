 ...
 */
public class MultiplicationValueLong extends Value<Long> {
     ...
     */
    @SuppressWarnings("rawtypes")
    public MultiplicationValueLong(Value factor1, Value factor2) {
    ...
    @Override
    protected void eval() {
        val = ((Number) factor1.get()).longValue() * ((Number) factor2.get()).longValue();
    }
}
