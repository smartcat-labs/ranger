...
public class BuildRunner {
	...
	private void recalculateRules() {
		...
		Set<RandomBuilder> builderSetWithRecalculatedRules = recalculatedBuilderSet(builderSet, builderFieldNameExclusiveRuleMap);
	...
	private Set<RandomBuilder> recalculatedBuilderSet(Set<RandomBuilder> builderSet, Map<RandomBuilder, Map<String, Rule>> builderFieldNameExclusiveRuleMap) {
		Set<RandomBuilder> result = Sets.newHashSet();
		
		for (Entry<RandomBuilder, Map<String, Rule>> entryBuilderFieldRule : builderFieldNameExclusiveRuleMap.entrySet()) {
